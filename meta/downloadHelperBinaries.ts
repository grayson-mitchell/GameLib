...
// idiom: this script is invoked via `esbuild --bundle ... | node` (the
// meta/ convention), so Node never sets `require.main`; `JEST_WORKER_ID` is
// set by Jest for every worker and reliably distinguishes "imported under
