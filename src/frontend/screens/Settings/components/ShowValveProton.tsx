    ...
    if (showValveProton) {
      ...
      showDialogModal({
        ...
        message: t(
          ...
          "We recommend custom Proton forks (GE-Proton, Proton-CachyOS, etc.) to be used with GameLib because Valve's Proton builds lack winetricks and protofixes. You can still use them if you want."
        ),
        buttons: [
          {
            text: t(
