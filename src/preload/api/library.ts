...
export const getCrossoverIndex = makeHandlerInvoker('getCrossoverIndex')
export const handleCrossoverIndexChanged = frontendListenerSlot('crossoverIndexChanged')
