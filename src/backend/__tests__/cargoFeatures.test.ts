...
const EXPECTED_LOCKFILE_CRATE_NAMES = [
  ...
  "chrono", "clipboard-win", "combine", "concurrent-queue", "const-random", "const-random-macro",
  "cookie", "core-foundation", "core-foundation-sys", "core-graphics", "core-graphics-types", "cpufeatures",
  "crc32fast", "crossbeam-channel", "crossbeam-utils", "crunchy", "crypto-common", "cssparser",
  "cssparser-macros", "ctor", "ctor-proc-macro", "darling", "darling_core", "darling_macro",
  "dbus", "dbus-secret-service", "deranged", "derive_arbitrary", "derive_more", "derive_more-impl",
  "digest", "dirs", "dirs-sys", "dispatch2", "displaydoc", "dlopen2",
  "dlopen2_derive", "dlv-list", "dom_query", "downcast-rs", "dpi", "dtoa",
  "dtoa-short", "dtor", "dtor-proc-macro", "dunce", "dyn-clone", "embed-resource",
  "embed_plist", "encoding_rs", "endi", "enumflags2", "enumflags2_derive", "equivalent",
  "erased-serde", "errno", "error-code", "event-listener", "event-listener-strategy", "fastrand",
  "fax", "fdeflate", "field-offset", "filetime", "find-msvc-tools", "fixedbitset",
  "flate2", "fnv", "foldhash", "foreign-types", "foreign-types-macros", "foreign-types-shared",
  "form_urlencoded", "futures-channel", "futures-core", "futures-executor", "futures-io", "futures-lite",
  "futures-macro", "futures-sink", "futures-task", "futures-util", "gamelib-shell", "gdk",
  "gdk-pixbuf", "gdk-pixbuf-sys", "gdk-sys", "gdkwayland-sys", "gdkx11", "gdkx11-sys",
  "generic-array", "gethostname", "getrandom", "gio", "gio-sys", "glib",
  "glib-macros", "glib-sys", "glob", "gobject-sys", "gtk", "gtk-sys",
  "gtk3-macros", "half", "hashbrown", "heck", "hermit-abi", "hex",
  ...
  "ndk-sys", "new_debug_unreachable", "nom", "notify-rust", "num-conv", "num-traits",
  "num_enum", "num_enum_derive", "objc2", "objc2-app-kit", "objc2-cloud-kit", "objc2-core-data",
  "objc2-core-foundation", "objc2-core-graphics", "objc2-core-image", "objc2-core-location", "objc2-core-text", "objc2-encode",
  "objc2-exception-helper", "objc2-foundation", "objc2-io-surface", "objc2-osa-kit", "objc2-quartz-core", "objc2-ui-kit",
  "objc2-user-notifications", "objc2-web-kit", "once_cell", "open", "openssl-probe", "option-ext",
  "ordered-multimap", "ordered-stream", "os_pipe", "osakit", "pango", "pango-sys",
  "parking", "parking_lot", "parking_lot_core", "percent-encoding", "petgraph", "phf",
  "phf_codegen", "phf_generator", "phf_macros", "phf_shared", "pin-project-lite", "piper",
  "pkg-config", "plist", "png", "polling", "potential_utf", "powerfmt",
  "ppv-lite86", "precomputed-hash", "proc-macro-crate", "proc-macro-error", "proc-macro-error-attr", "proc-macro2",
  "pxfm", "quick-error", "quick-xml", "quote", "r-efi", "rand",
  "rand_chacha", "rand_core", "raw-window-handle", "redox_syscall", "redox_users", "ref-cast",
  "ref-cast-impl", "regex", "regex-automata", "regex-syntax", "reqwest", "rfd",
  "ring", "rust-ini", "rustc-hash", "rustc_version", "rustix", "rustls",
  "rustls-native-certs", "rustls-pki-types", "rustls-platform-verifier", "rustls-platform-verifier-android", "rustls-webpki", "rustversion",
  "same-file", "schannel", "schemars", "schemars_derive", "scopeguard", "security-framework",
  "security-framework-sys", "selectors", "semver", "serde", "serde-untagged", "serde_core",
  "serde_derive", "serde_derive_internals", "serde_json", "serde_repr", "serde_spanned", "serde_with",
  "serde_with_macros", "serialize-to-javascript", "serialize-to-javascript-impl", "servo_arc", "sha2", "shared_child",
  "shlex", "sigchld", "signal-hook", "signal-hook-registry", "simd-adler32", "simd_cesu8",
  "simdutf8", "siphasher", "slab", "smallvec", "socket2", "softbuffer",
  "soup3", "soup3-sys", "stable_deref_trait", "string_cache", "string_cache_codegen", "strsim",
  "subtle", "swift-rs", "syn", "sync_wrapper", "synstructure", "system-deps",
  "tao", "tao-macros", "tar", "target-lexicon", "tauri", "tauri-build",
  "tauri-codegen", "tauri-macros", "tauri-plugin", "tauri-plugin-clipboard-manager", "tauri-plugin-deep-link", "tauri-plugin-dialog",
  ...
  "tiny-keccak", "tinystr", "tinyvec", "tinyvec_macros", "tokio", "tokio-rustls",
  "tokio-util", "toml", "toml_datetime", "toml_edit", "toml_parser", "toml_writer",
  "tower", "tower-http", "tower-layer", "tower-service", "tracing", "tracing-attributes",
  "tracing-core", "tray-icon", "tree_magic_mini", "try-lock", "typeid", "typenum",
  "uds_windows", "unic-char-property", "unic-char-range", "unic-common", "unic-ucd-ident", "unic-ucd-version",
  "unicode-ident", "unicode-segmentation", "untrusted", "url", "urlpattern", "utf8_iter",
  "uuid", "version-compare", "version_check", "vswhom", "vswhom-sys", "walkdir",
  "want", "wasi", "wasip2", "wasm-bindgen", "wasm-bindgen-futures", "wasm-bindgen-macro",
  "wasm-bindgen-macro-support", "wasm-bindgen-shared", "wasm-streams", "wayland-backend", "wayland-client", "wayland-protocols",
  "wayland-protocols-wlr", "wayland-scanner", "wayland-sys", "web-sys", "web_atoms", "webkit2gtk",
  "webkit2gtk-sys", "webpki-root-certs", "webview2-com", "webview2-com-macros", "webview2-com-sys", "weezl",
  "winapi", "winapi-i686-pc-windows-gnu", "winapi-util", "winapi-x86_64-pc-windows-gnu", "window-vibrancy", "windows",
  "windows-collections", "windows-core", "windows-future", "windows-implement", "windows-interface", "windows-link",
  "windows-numerics", "windows-registry", "windows-result", "windows-strings", "windows-sys", "windows-targets",
  ...
  "wit-bindgen", "wl-clipboard-rs", "writeable", "wry", "x11", "x11-dl",
  "x11rb", "x11rb-protocol", "xattr", "yoke", "yoke-derive", "zbus",
  "zbus_macros", "zbus_names", "zerocopy", "zerocopy-derive", "zerofrom", "zerofrom-derive",
  "zeroize", "zeroize_derive", "zerotrie", "zerovec", "zerovec-derive", "zip",
  "zmij", "zune-core", "zune-jpeg", "zvariant", "zvariant_derive", "zvariant_utils"
]
