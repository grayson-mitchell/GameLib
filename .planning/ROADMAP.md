...
Plans:
- [ ] 34.5-01-PLAN.md — Wave-1 seam 1: pathShim desktop/exe/documents + GAMELIB_SHELL_EXE on both Rust spawn paths + pathShim.test.ts (wave 1)
...
- [ ] 34.5-09-PLAN.md — DXVK/VKD3D toggles, completing the Wine cluster at 9, + the dialog-already-safe verification (wave 3)
- [ ] 34.5-10-PLAN.md — Amazon auth, completing the auth cluster at 11 (wave 3)
- [ ] 34.5-11-PLAN.md — Shortcuts B: addToSteam/removeFromSteam/isAddedToSteam + the unset-exe loud-throw pin (wave 3)
- [ ] 34.5-12-PLAN.md — callTool/egsSync/getGOGLinuxInstallersLangs + both saves-sync channels (wave 3)
- [ ] 34.5-13-PLAN.md — Reach ledger regenerated by measurement + all-38 completeness + both Discretion sweeps (wave 4)
