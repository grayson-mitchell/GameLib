...
- [ ] **Phase 31: IPC re-plumb slice 2 (settings/config)** - Settings/config cluster plus the Tauri `dialog` plugin surface those flows need (all 3 plans executed 2026-07-23; verification gaps_found — REQ-31-03 dialog auto-confirm blocker open, awaiting gap closure)
