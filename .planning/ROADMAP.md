...
- [ ] 35-26-PLAN.md — REQ-35-17 EOS: move the destructive confirmation renderer-side, fail-closed on anything but a literal `true` (wave 1, **not autonomous**)
