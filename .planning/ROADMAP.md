...
- [ ] 35-24-PLAN.md — A-17 anti-rot: regenerate `i18nForkTouchedFiles.json` AND re-baseline the `--rewrite-scope` fixture counts AND the A-03 debt set, in ONE commit (wave 1)
