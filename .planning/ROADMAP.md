...
- [!] 35-09-PLAN.md — **BLOCKED, NOTHING BUILT** — prescribed `clear_all_browsing_data()` is banned in `main.rs` x3 and by CLOSED REQ-34.4.1-06. Operator chose option (a), apex-domain list. Needs re-planning (`D-35-09-01`) (wave 6)
