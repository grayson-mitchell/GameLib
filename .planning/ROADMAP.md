...
- [ ] 35-27-PLAN.md — criterion 16 / `D-35-08-02`: split "is an operation pending?" from "which sleep kind should it block?" (wave 2, **not autonomous**)
