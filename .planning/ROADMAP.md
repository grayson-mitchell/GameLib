...
- [ ] 35-23-PLAN.md — REQ-35-07: Epic per-domain cookie census, and the fatal-logout predicate distinguishes an empty jar from a broken clear (CR-04 backend half) (wave 1)
