...
- [ ] 35-22-PLAN.md — CR-03 `window.platform` gains a `win32` arm + CR-04 renderer half: a failed logout reaches `gamelib.log` and the user (wave 1)
