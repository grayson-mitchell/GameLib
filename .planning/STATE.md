...
Last activity: 2026-08-15 -- Completed quick task 260815-j24: frameless titlebar cleanup -- brand icon
  unmounted from the navbar, tab strip now flush to the 16px tier-2 panel gutter, --navbar-height
  56px->42px for a 5px band above the tabs. Live UAT checkpoint still PENDING.
