...
LIVE APPEARANCE NOT VERIFIED -- 4 human-gate items OWED (badge placement, badge absence at 0,
per-theme legibility, and the `42 of 318` -> `318` round trip). Prior: quick task 260815-mk1: the
