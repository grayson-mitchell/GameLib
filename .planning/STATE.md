...
Last activity: 2026-08-15 -- Completed quick task 260815-k25: added `hiddenTitle: true` so AppKit stops
  ...
  whose live UAT the user confirmed seamless. k25's live UAT checkpoint is still PENDING (Rust relink).
