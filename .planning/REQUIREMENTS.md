...
- [ ] **REQ-30-03**: Sign-off for this phase is automated tests asserting channel wiring and token round-trip. The live human QR scan is logged as a **single deferred UAT item that also names the install E2E it gates**, so the phase's claim reads as "wired and unit-proven", never "hardware-proven". *(D-04 + its ⚠ tension note)*
