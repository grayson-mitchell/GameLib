...
- `genericSpawnWrapper()` --references--> `child_process`  [EXTRACTED]
  src/backend/utils/os/processes/index.ts → flatpak/prepareFlatpak.js
- `PopoverComponent()` --references--> `react`  [EXTRACTED]
  src/frontend/components/UI/PopoverComponent/index.tsx → package.json
- `WebviewControls()` --references--> `react`  [EXTRACTED]
  src/frontend/components/UI/WebviewControls/index.tsx → package.json
- `ContextMenu()` --references--> `react`  [EXTRACTED]
  src/frontend/screens/Library/components/ContextMenu/index.tsx → package.json
- `AnalyticsDialog()` --references--> `react`  [EXTRACTED]
  src/frontend/screens/Settings/components/AnalyticsDialog.tsx → package.json

## Import Cycles
- 3-file cycle: `src/frontend/screens/Settings/index.tsx -> src/frontend/screens/Settings/sections/index.tsx -> src/frontend/screens/Settings/sections/GamesSettings/index.tsx -> src/frontend/screens/Settings/index.tsx`
...
### Community 2 - "misc.ts"
Cohesion: 0.03
Nodes (72): authAmazon, authGOG, callTool, changeLanguage, checkDiskSpace, checkGameUpdates, clearAchievementCache, clearCache (+64 more)

### Community 3 - "NileGameManager"
Cohesion: 0.15
...
Cohesion: 0.13
Nodes (8): AddGameButtonProps, CHARS, EmptyLibraryMessage(), Props, TODO: we can remove this eventually after a few releases and just use the code o, TODO: we can remove this eventually after a few releases and just use the code o, SearchableGame, initialContext
...
### Community 25 - "gog.ts"
Cohesion: 0.06
Nodes (39): BuildItem, Currency, DLCInfo, FeatureSupport, FileTask, Friend, GalaxyLibraryEntry, GameInstallInfo (+31 more)

### Community 26 - "helpers.ts"
Cohesion: 0.11
Nodes (32): DiscountCard(), Props, MultiSelectChipsProps, OS_PLATFORM_KEY, Props, SlugOption, buildPageList(), DiscountPagination() (+24 more)
...
Cohesion: 0.15
Nodes (12): DLCInfo, FuelPostInstall, FuelSchema, GameInstallInfo, GameManifest, NileGameDownloadInfo, NileGameInfo, NileGameProduct (+4 more)

### Community 32 - "compilerOptions"
Cohesion: 0.05
Nodes (34): { compilerOptions }, dom, dom.iterable, esnext, **/__mocks__/**, sign, src, vite.config.ts (+26 more)
...
Cohesion: 0.15
Nodes (27): addNonSteamGame(), checkIfAlreadyAdded(), checkIfShortcutObjectIsValid(), checkSteamUserDataDir(), getAppName(), getSteamUserdataDir(), hasParameterCaseInsensitive(), isAddedToSteam() (+19 more)

### Community 37 - "index.tsx"
Cohesion: 0.13
Nodes (24): BackHint(), ButtonId, ConfirmDialog(), ConfirmDialogProps, ACTIVE_STATUSES, ConsoleCard, Props, LaunchOverlay() (+16 more)

### Community 38 - "classify.test.ts"
Cohesion: 0.11
Nodes (30): directRedeemEntitlementOrder, drmFreeOnlyOrder, ebookBundleOrder, malformedTpkOrder, minimalTpkOrder, mixedKeyAndDirectRedeemEntitlementOrder, mixedKeyAndEntitlementOrder, nonSteamPlatformOrder (+22 more)
...
Cohesion: 0.07
Nodes (26): handleHumbleAuthState, handleHumbleKeysUpdated, handleHumbleSyncProgress, handleHumbleSyncStateChanged, humbleCheckHealth, humbleClearOwnershipOverride, humbleDisconnect, humbleGetClaimAnnotations (+18 more)
...
Cohesion: 0.10
Nodes (22): desktop-launch script, append_dir(), APPIMAGE_EXTRACT_AND_RUN, ARCH, ensure_dir_exists(), GST_PLUGIN_PATH, GST_PLUGIN_SCANNER, GST_PLUGIN_SYSTEM_PATH (+14 more)

### Community 70 - "tray_icon.ts"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (11): createdNetRequests, FakeClientRequest, FakeIncomingMessage, mockGet, mockIsAxiosError, mockLogError, mockLogInfo, mockLogWarning (+3 more)

### Community 81 - "index.tsx"
Cohesion: 0.11
Nodes (15): ChangelogModal(), lastChangelog, Props, Dialog(), DialogProps, HACK: Focussing the dialog using JS does not seem to work, StyledPaper, DialogContent() (+7 more)

### Community 82 - "Type definitions (devDependency)"
Cohesion: 0.09
...
Cohesion: 0.09
Nodes (22): Building GameLib Binaries, Building with VS Code, Credits, Development environment, Development on Nix, Features available right now, GameLib, Help with Translations [Here](https://hosted.weblate.org/projects/heroic-games-launcher) (+14 more)
...
Cohesion: 0.15
Nodes (12): description, engines, node, homepage, license, main, name, packageManager (+4 more)

### Community 94 - "TourContext.tsx"
Cohesion: 0.19
...
Cohesion: 0.13
Nodes (7): initGamepad(), checkGenius1(), checkGameCube(), checkN64Clone1(), checkPS3Clone1(), checkStandard(), VirtualKeyboardController

### Community 124 - "settings.ts"
Cohesion: 0.10
...
Cohesion: 0.11
Nodes (18): AssetInfo, CustomAttributeType, CustomAttributeValue, DLCInfo, GameInstallInfo, GameManifest, GameMetadata, InstalledJsonMetadata (+10 more)
...
Cohesion: 0.11
Nodes (25): assertNonEmpty(), canonicalName(), Collision, compareVersion(), dedupRecords(), DedupResult, DumpRecord, extractRecords() (+17 more)
...
Cohesion: 0.25
Nodes (10): getDecryptedApiKey(), readStoredApiKey(), decryptApiKey(), encryptApiKey(), encryptionAvailable(), isEncryptedValue(), mockedAxios, getGrids() (+2 more)
...
Cohesion: 0.25
Nodes (7): electronTest(), main_js, resetAllStubs(), resetGogdlCommandStub(), resetLegendaryCommandStub(), resetNileCommandStub(), supportedLanguages

### Community 261 - "DotsMenu.tsx"
Cohesion: 0.15
Nodes (5): GameChangeLog(), GameChangeLogProps, Props, Props, Props

### Community 262 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
...
Cohesion: 0.32
Nodes (8): download(), _get(), isInstalled(), testTarFilePath, downloadFile(), extractTarFile(), getAssetDataFromDownload(), GithubAssetMetadata

### Community 310 - "hasStatus.ts"
Cohesion: 0.29
Nodes (8): getStatusLabel(), handleNonAvailableGames(), nonAvailbleGamesArray, StatusArgs, hasProgress(), DerivedStatusKind, deriveInstallStatusKind(), hasStatus()

### Community 311 - "index.tsx"
Cohesion: 0.17
Nodes (4): AltGOGdlBin(), AltLegendaryBin(), AltNileBin(), SteamGridDbApiKey()

### Community 312 - "FAQ"
Cohesion: 0.18
Nodes (10): FAQ, Fixed Spacing, Frotend Design System, How do I pick the spacing values?, How should I handle border-radius?, I can't find the px value I want. Can I hardcode it?, Relative Spacing, Spacing System (+2 more)

### Community 323 - "index.test.tsx"
Cohesion: 0.22
...
Cohesion: 0.22
Nodes (3): QuitButtonProps, SidebarItemProps, PathSplit

### Community 371 - "AppleWikiInfo.tsx"
Cohesion: 0.36
Nodes (5): capitalize(), RatingTier, AppleWikiInfo(), Props, protonTierToStars()

### Community 372 - "index.tsx"
Cohesion: 0.25
Nodes (5): GOGModifyInstallModal, TODO: Handle error, ModifyInstallProps, LegendaryModifyInstallModal(), LegendaryModifyInstallModalProps

### Community 374 - "Heroic Games Launcher — Copilot Instructions"
Cohesion: 0.25
Nodes (7): Architecture Overview, Frontend Conventions, Heroic Games Launcher — Copilot Instructions, IPC Communication (Critical Pattern), Logging, Store Manager Pattern, Wine/Proton Management (Linux & macOS)

### Community 375 - "lintTranslations.ts"
Cohesion: 0.43
Nodes (7): checkFileAgainstEnglish(), checkLanguage(), checkStringValueAgainstEnglish(), checkValueAgainstEnglish(), enFiles, readFile(), readFiles()

### Community 416 - "manifest.json"
Cohesion: 0.25
Nodes (7): background_color, display, icons, name, short_name, start_url, theme_color

### Community 417 - "CrossOver Compatibility Lookup Spike — Findings"
Cohesion: 0.25
Nodes (7): Captured per-title results (live run), Critical protocol correction (deviation from pre-spike VERIFIED FACTS), CrossOver Compatibility Lookup Spike — Findings, GO / NO-GO Recommendation, Observations on failure modes, Reminder, Sample titles and generated slugs

### Community 418 - "constants.ts"
Cohesion: 0.23
Nodes (11): buildMaps(), crossoverIndexHas(), getCodeweaversFromIndex(), IndexLookupInput, IndexMaps, isCrossoverIndexEligible(), resolveRating(), buildCrossoverRatingMap() (+3 more)

### Community 420 - "index.tsx"
Cohesion: 0.36
Nodes (5): useSetting(), Props, useSettingsContext(), Accessibility, AccessibilityWrapper()

### Community 421 - "HumbleOriginInfo.test.tsx"
Cohesion: 0.29
Nodes (4): HumbleOriginInfo(), Props, mockKeys, Rendered

### Community 439 - "CrossOver Bottle Create-Probe — Findings"
Cohesion: 0.29
Nodes (6): Attempt Results, CrossOver Bottle Create-Probe — Findings, cxbottle --help output, Environment, MECHANISM DECISION, Note for 17-04

### Community 440 - "probe-cxbottle.sh"
Cohesion: 0.33
Nodes (6): BOTTLE_DIR, check_result(), CONF_PATH, CXBOTTLE, NAME, probe-cxbottle.sh script

### Community 441 - "index.ts"
Cohesion: 0.38
Nodes (5): buildUrl(), CatalogResponse, FALLBACK_LOCALE, fetchAllDiscounts(), fetchPage()

### Community 442 - "linux.ts"
Cohesion: 0.06
Nodes (37): removeSpecialcharacters(), testAppleGamingWikiInfo, EMPTY_APPLEGAMINGWIKI_INFO, getInfoFromAppleGamingWiki(), getPageID(), getWikiText(), baseSlugify(), classifyReviewOS() (+29 more)

### Community 443 - "dom-additions.ts"
Cohesion: 0.29
Nodes (4): FontData, Navigator, Window, WindowControlsOverlay

### Community 444 - "extra-mock-function.ts"
Cohesion: 0.29
Nodes (6): backend/config, BrowserWindow, Electron, GlobalConfig, FIXME: This file is required because we add functionality to some objects, Tray

### Community 445 - "WineManagerSettingsModal.tsx"
Cohesion: 0.29
...
Cohesion: 0.53
Nodes (4): handleSteamBottleSetupRequiredSignal(), isSteamBottleSetupActiveFor(), SteamBottleSetupState, useSteamBottleSetup

### Community 477 - "Overview of Frontend testing enviroment"
Cohesion: 0.40
Nodes (4): Configuration files, Mocks, Overview of Frontend testing enviroment, Pre defined type configurations

### Community 478 - "electron.vite.config.ts"
Cohesion: 0.40
Nodes (4): dependenciesToNotExternalize, FIXME: Potentially publish this as a dedicated plugin, if other projects, srcAliases, vite_plugin_react_dev_tools

### Community 511 - ".prettierrc.json"
Cohesion: 0.40
Nodes (4): semi, singleQuote, tabWidth, trailingComma

### Community 514 - "steam-shortcut-editor.d.ts"
Cohesion: 0.40
Nodes (4): Options, ShortcutEntry, ShortcutObject, steam-shortcut-editor

### Community 516 - "epic-graphql.ts"
Cohesion: 0.40
Nodes (4): Catalog, CatalogMapping, Product, ProductConfig

### Community 518 - "index.tsx"
Cohesion: 0.60
Nodes (3): WineItem(), FIXME: Enable noUncheckedIndexedAccess in tsconfig to remove this `undefined`, useWineManagerState

### Community 519 - "Support Heroic Development"
Cohesion: 0.40
Nodes (4): Buy a Cofee: [Ko-fi](https://ko-fi.com/flavioislima), Support Heroic Development, Support Monthly: [Patreon Page](https://patreon.com/heroicgameslauncher), Support with Crypto

### Community 562 - "urgencyBadge.test.ts"
Cohesion: 0.83
Nodes (3): daysFromNow(), hoursFromNow(), NOW

### Community 568 - "useLaunchOptions.ts"
Cohesion: 0.67
...
### Community 572 - "InstallProgress.ts"
Cohesion: 0.67
...
Cohesion: 0.21
Nodes (13): CachedIndex, crossoverIndexStore, assertHttps(), IndexDescriptor, loadBundledSnapshot(), loadIndex(), parseGzippedJson(), persistBundledFallback() (+5 more)

### Community 845 - "normalize.ts"
Cohesion: 0.73
Nodes (4): baseTransform(), normalizeExactLowercase(), normalizePunctuationAndEditionStripped(), normalizePunctuationStripped()

### Community 846 - "ratingMap.test.ts"
Cohesion: 0.33
