...
**2026-08-27 update (quick `260827-ua7`):** WR-08 and WR-16 are now **FIXED**
(`a9b6ef51a` for WR-08, `4329529e0` for WR-16; see `34.11-REVIEW-FIX.md` for the
per-finding evidence) and are removed from the groups below, along with their now-empty
**UX** and **Test quality** headings. The remaining three — WR-10, WR-11, WR-18 — were
not re-swept by this task and are carried unchanged.

`34.11-REVIEW.md` found 4 Critical and 19 Warning findings. All 4 Criticals plus WR-01
through WR-09, WR-12 through WR-16 and WR-19 are discharged, and WR-17 is
reclassified invalid — swept against `HEAD` and ledgered per finding in
`34.11-REVIEW-FIX.md`. **Three Warnings were confirmed still present** (WR-10, WR-11,
WR-18) and are collected here so they are not carried unowned.
