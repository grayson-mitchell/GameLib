...
- **Open before shipping:** input/scroll feel (needs a human on the interactive harness),
  ...
  Phase 40 Plan 10); Epic's anti-bot posture filed as spike 024, planned but not yet run (D-05).
